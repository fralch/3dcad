                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="w-full md:w-80 p-6 border-l border-gray-100">
                                        ...
                                        <div className="space-y-3">
                                            <button className="w-full flex items-center justify-center gap-2 bg-secondary-500 hover:bg-secondary-400 text-white py-3 rounded-lg font-bold transition-colors">
